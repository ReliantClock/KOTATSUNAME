export const CATALOG = [ 
  ...
  },
  {
    ...
    generos: ["romance", "drama", "escolar"], temporadas: 3, cover: "002.jpeg",
  ...
  },
  {
    ...
    generos: ["romance", "fantasia", "historico"], temporadas: 1, cover: "009.jpeg",
  ...
  {
    id: 10, titulo: "Uri Sa-i e (Something About Us)", tipo: ["manhwa"],
  ...
  },
  {
    ...
    generos: ["romance", "comedia", "escolar"], temporadas: 1, cover: "013.jpeg",
  ...
  {
    id: 14, titulo: "Adachi to Shimamura", tipo: ["manga", "anime"],
    generos: ["romance", "recuentos de la vida", "escolar", "yuri"], temporadas: 1, cover: "014.jpeg",
  ...
  {
    id: 15, titulo: "Otonari no Tenshi-sama ni Itsu no Ma ni ka Dame Ningen ni Sareteita Ken", tipo: ["manga", "anime"],
    generos: ["romance", "recuentos de la vida", "escolar"], temporadas: 1, cover: "015.jpeg",
  ...
  },
  {
    ...
    generos: ["romance", "fantasia", "accion"], temporadas: 1, cover: "017.jpeg",
  ...
  },
  {
    ...
    generos: ["romance", "comedia", "adulto"], temporadas: 1, cover: "020.jpeg",
  ...
  {
    id: 21, titulo: "Orange", tipo: ["manga", "anime"],
    generos: ["romance", "drama", "sci-fi"], temporadas: 1, cover: "021.jpeg",
  ...
  {
    id: 22, titulo: "Gongnyeonim-eun Oegyein (The Reason Why Raeliana Ended Up at the Duke's Mansion)", tipo: ["manhwa", "anime"],
    generos: ["romance", "misterio", "fantasia"], temporadas: 1, cover: "022.jpeg",
  ...
  {
    id: 23, titulo: "Ao Haru Ride", tipo: ["manga", "anime"],
    generos: ["romance", "drama", "escolar"], temporadas: 1, cover: "023.jpeg",
  ...
  {
    id: 24, titulo: "Shi Yi Chang'an (Memory of Chang'an)", tipo: ["donghua"],
    generos: ["romance", "historico", "drama"], temporadas: 1, cover: "024.jpeg",
  ...
  {
    id: 25, titulo: "Ouran Koukou Host Club", tipo: ["manga", "anime"],
    generos: ["romance", "comedia", "escolar"], temporadas: 1, cover: "025.jpeg",
  ...
  },
  {
    ...
    generos: ["romance", "drama", "escolar"], temporadas: 1, cover: "027.jpeg",
  ...
  {
    id: 28, titulo: "Ijiranaide, Nagatoro-san", tipo: ["manga", "anime"],
    generos: ["romance", "comedia", "escolar"], temporadas: 2, cover: "028.jpeg",
  ...
  {
    id: 29, titulo: "Golden Time", tipo: ["manga", "anime"],
    generos: ["romance", "drama", "adulto"], temporadas: 1, cover: "029.jpeg",
  ...
  {
    id: 30, titulo: "Yeosin-gangnim (True Beauty)", tipo: ["manhwa", "anime"],
    generos: ["romance", "drama", "escolar"], temporadas: 1, cover: "030.jpeg",
  ...
  {
    id: 31, titulo: "Osake wa Fuufu ni Natte kara", tipo: ["manga", "anime"],
    generos: ["romance", "comedia", "adulto"], temporadas: 1, cover: "031.jpeg",
  ...
  },
  {
    ...
    generos: ["romance", "recuentos de la vida"], temporadas: 3, cover: "032.jpeg",
  ...
  {
    id: 33, titulo: "Kimi wa Houkago Insomnia", tipo: ["manga", "anime"],
    generos: ["romance", "recuentos de la vida", "escolar"], temporadas: 1, cover: "033.jpeg",
  ...
  {
    id: 34, titulo: "Sanae Matschum (Business Proposal)", tipo: ["manhwa"],
  ...
  {
    id: 35, titulo: "Kanojo, Okarishimasu", tipo: ["manga", "anime"],
    generos: ["romance", "comedia", "escolar"], temporadas: 3, cover: "035.jpeg",
  ...
  {
    id: 36, titulo: "Tonari no Kaibutsu-kun", tipo: ["manga", "anime"],
    generos: ["romance", "comedia", "escolar"], temporadas: 1, cover: "036.jpeg",
  ...
  {
    id: 37, titulo: "Mahoutsukai no Yome", tipo: ["manga", "anime"],
    generos: ["romance", "fantasia", "sobrenatural"], temporadas: 2, cover: "037.jpeg",
  ...
  {
    id: 38, titulo: "Akuyaku Reijou nano de Last Boss wo Kattemimashita", tipo: ["manga", "anime"],
    generos: ["romance", "fantasia", "comedia"], temporadas: 1, cover: "038.jpeg",
  ...
  {
    id: 39, titulo: "Bimil Dongmaeng (Secret Alliance)", tipo: ["manhwa"],
  ...
  {
    id: 40, titulo: "ReLIFE", tipo: ["manga", "anime"],
    generos: ["romance", "drama", "escolar"], temporadas: 1, cover: "040.jpeg",
  ...
  {
    id: 41, titulo: "Kamisama Hajimemashita", tipo: ["manga", "anime"],
    generos: ["romance", "comedia", "sobrenatural"], temporadas: 2, cover: "041.jpeg",
  ...
  {
    id: 42, titulo: "Ling Qi (Spiritpact)", tipo: ["donghua"],
    generos: ["romance", "sobrenatural", "accion"], temporadas: 2, cover: "042.jpeg",
  ...
  {
    id: 43, titulo: "Sasaki to Miyano", tipo: ["manga", "anime"],
    generos: ["romance", "recuentos de la vida", "escolar"], temporadas: 1, cover: "043.jpeg",
  ...
  {
    id: 45, titulo: "Yamada-kun to Lv999 no Koi wo Suru", tipo: ["manga", "anime"],
    generos: ["romance", "comedia", "adulto"], temporadas: 1, cover: "045.jpeg",
  ...
  {
    id: 46, titulo: "Hachimitsu to Clover", tipo: ["manga", "anime"],
    generos: ["romance", "drama", "recuentos de la vida"], temporadas: 2, cover: "046.jpeg",
  ...
  {
    id: 47, titulo: "Lee Doona! (The Girl Downstairs)", tipo: ["manhwa", "anime"],
    generos: ["romance", "drama", "escolar"], temporadas: 1, cover: "047.jpeg",
  ...
  {
    id: 48, titulo: "Kaguya-sama wa Kokurasetai: Tensai-tachi no Renai Zunousen", tipo: ["manga", "anime"],
    generos: ["romance", "comedia", "escolar"], temporadas: 3, cover: "048.jpeg",
  ...
  {
    id: 49, titulo: "Yagate Kimi ni Naru (Bloom Into You)", tipo: ["manga", "anime"],
    generos: ["romance", "drama", "escolar", "yuri"], temporadas: 1, cover: "049.jpeg",
  ...
  {
    id: 50, titulo: "Anitomo", tipo: ["manga", "anime"],
    generos: ["romance", "comedia", "escolar"], temporadas: 1, cover: "050.jpeg",
  ...
  {
    id: 51, titulo: "Make Heroine ga Oosugiru!", tipo: ["manga", "anime"],
    generos: ["romance", "comedia", "escolar"], temporadas: 1, cover: "051.jpeg",
  ...
  {
    id: 52, titulo: "Ao no Hako", tipo: ["manga", "anime"],
    generos: ["romance", "deportes", "escolar"], temporadas: 1, cover: "052.jpeg",
  ...
  {
    id: 53, titulo: "Chuunibyou demo Koi ga Shitai!", tipo: ["manga", "anime"],
    generos: ["romance", "comedia", "escolar"], temporadas: 2, cover: "053.jpeg",
  ...
  {
    id: 54, titulo: "Kaoru Hana wa Rin to Saku", tipo: ["manga"],
  ...
  {
    id: 55, titulo: "Dosanko Gal wa Naara Menkoi", tipo: ["manga", "anime"],
    generos: ["romance", "comedia", "escolar"], temporadas: 1, cover: "055.jpeg",
  ...
  {
    id: 56, titulo: "Yubisaki to Renren", tipo: ["manga", "anime"],
    generos: ["romance", "recuentos de la vida"], temporadas: 1, cover: "056.jpeg",
  ...
  {
    id: 57, titulo: "Go-Toubun no Hanayome", tipo: ["manga", "anime"],
    generos: ["romance", "comedia", "escolar"], temporadas: 2, cover: "057.jpeg",
  ...
  {
    id: 58, titulo: "Clannad", tipo: ["manga", "anime"],
    generos: ["romance", "drama", "recuentos de la vida"], temporadas: 2, cover: "058.jpeg",
  ...
  {
    id: 59, titulo: "Tsurezure Children", tipo: ["manga", "anime"],
    generos: ["romance", "comedia", "escolar"], temporadas: 1, cover: "059.jpeg",
  ...
  {
    id: 60, titulo: "Toradora!", tipo: ["manga", "anime"],
    generos: ["romance", "comedia", "escolar"], temporadas: 1, cover: "060.jpeg",
  ...
  {
    id: 61, titulo: "Ag-yeog-ui Ending-eun Jugeumppun (Villains are Destined to Die)", tipo: ["manhwa"],
  ...
  {
    id: 62, titulo: "Loop 7-kaime no Akuyaku Reijou wa, Moto Tekigoku de Jiyuu Kimama na Hanayome Seikatsu wo Mankitsu suru", tipo: ["manga", "anime"],
    generos: ["romance", "fantasia"], temporadas: 1, cover: "062.jpeg",
  ...
  {
    id: 63, titulo: "Hananoi-kun to Koi no Yamai", tipo: ["manga", "anime"],
    generos: ["romance", "escolar"], temporadas: 1, cover: "063.jpeg",
  ...
  {
    id: 64, titulo: "Amagami-san Chi no Enmusubi", tipo: ["manga", "anime"],
    generos: ["romance", "comedia", "sobrenatural"], temporadas: 1, cover: "064.jpeg",
  ...
  {
    id: 65, titulo: "Kusuriya no Hitorigoto", tipo: ["manga", "anime"],
    generos: ["romance", "misterio", "historico"], temporadas: 2, cover: "065.jpeg",
  ...
  {
    id: 66, titulo: "Horimiya", tipo: ["manga", "anime"],
    generos: ["romance", "comedia", "escolar"], temporadas: 2, cover: "066.jpeg",
  ...
  {
    id: 67, titulo: " 재혼 황후 (Remarried Empress)", tipo: ["manhwa"],
  ...
  {
    id: 68, titulo: "Akagami no Shirayuki-hime", tipo: ["manga", "anime"],
    generos: ["romance", "fantasia"], temporadas: 2, cover: "068.jpeg",
  ...
  {
    id: 69, titulo: "Ookami Shoujo to Kuro Ouji", tipo: ["manga", "anime"],
    generos: ["romance", "comedia", "escolar"], temporadas: 1, cover: "069.jpeg",
  ...
  {
    id: 70, titulo: "Koori Zokusei Danshi to Cool na Douryou Joshi", tipo: ["manga", "anime"],
    generos: ["romance", "recuentos de la vida", "sobrenatural"], temporadas: 1, cover: "070.jpeg",
  ...
  {
    id: 71, titulo: "Romantic Killer", tipo: ["manga", "anime"],
    generos: ["romance", "comedia", "sobrenatural"], temporadas: 1, cover: "071.jpeg",
  ...
  {
    id: 72, titulo: "Uli-ui Yeonaesim (Our Dating Sim)", tipo: ["manhwa"],
  ...
  {
    id: 73, titulo: "Yamada-kun to Lv999 no Koi wo Suru", tipo: ["manga", "anime"],
    generos: ["romance", "comedia", "videojuegos"], temporadas: 1, cover: "073.jpeg",
  ...
  {
    id: 74, titulo: "Ao Haru Ride", tipo: ["manga", "anime"],
    generos: ["romance", "drama", "escolar"], temporadas: 1, cover: "074.jpeg",
  ...
  {
    id: 75, titulo: "Kaichou wa Maid-sama!", tipo: ["manga", "anime"],
    generos: ["romance", "comedia", "escolar"], temporadas: 1, cover: "075.jpeg",
  ...
  },
  {
    ...
    generos: ["accion", "fantasia", "aventura", "shounen", "historia", "sobrenatural"], temporadas: 5, cover: "076.jpeg",
  ...
  {
    id: 77, titulo: "Na Honjaman Level Up (Solo Leveling)", tipo: ["manhwa", "anime"],
    generos: ["accion", "aventura", "fantasia", "video juegos", "sobrenatural"], temporadas: 2, cover: "077.jpeg",
  ...
  },
  {
    ...
    generos: ["isekai", "fantasia", "aventura", "ecchi", "magia"], temporadas: 3, cover: "078.jpeg",
  ...
  },
  {
    ...
    generos: ["accion", "aventura", "fantasia", "isekai", "magia"], cover: "079.jpeg",
  ...
  },
  {
    ...
    generos: ["accion", "terror", "sobrenatural", "shounen", "drama"], temporadas: 2, cover: "080.jpeg",
  ...
  },
  {
    ...
    generos: ["accion", "sobrenatural", "escolar", "shounen", "terror"], temporadas: 3, cover: "081.jpeg",
  ...
  {
    id: 82, titulo: "Jeonjijeok Dokja Sijeom (Omniscient Reader's Viewpoint)", tipo: ["manhwa", "anime"],
    generos: ["accion", "aventura", "fantasia", "psicologico"], temporadas: 1, cover: "082.jpeg",
  ...
  },
  {
    ...
    generos: ["isekai", "drama", "fantasia", "psicologico", "misterio"], temporadas: 3, cover: "083.jpeg",
  ...
  },
  {
    ...
    generos: ["isekai", "fantasia", "aventura", "comedia", "magia", "shounen"], temporadas: 3, cover: "084.jpeg",
  ...
  },
  {
    ...
    generos: ["accion", "historia", "artes marciales", "seinen", "drama", "psicologico"], cover: "085.jpeg",
  ...
  },
  {
    ...
    generos: ["accion", "isekai", "comedia", "fantasia", "magia"], temporadas: 2, cover: "086.jpeg",
  ...
  },
  {
    ...
    generos: ["accion", "artes marciales", "drama", "escolar"], cover: "087.jpeg",
  ...
  },
  {
    ...
    generos: ["accion", "sci-fi", "psicologico", "drama"], temporadas: 1, cover: "088.jpeg",
  ...
  },
  {
    ...
    generos: ["accion", "fantasia", "terror", "seinen", "drama"], temporadas: 2, cover: "089.jpeg",
  ...
  {
    id: 90, titulo: "Kaiju 8-gou", tipo: ["manga", "anime"],
    generos: ["accion", "sci-fi", "militar", "shounen", "sobrenatural", "comedia"], temporadas: 2, cover: "090.jpeg",
  ...
  {
    id: 91, titulo: "Shangri-La Frontier: Kusoge Hunter, Kamige ni Idoman to su", tipo: ["manga", "anime"],
    generos: ["accion", "aventura", "video juegos", "fantasia", "shounen", "comedia"], temporadas: 2, cover: "091.jpeg",
  ...
  {
    id: 92, titulo: "Nano Masin (Nano Machine)", tipo: ["manhwa"],
    generos: ["accion", "aventura", "sci-fi", "artes marciales"], cover: "092.jpeg",
  ...
  },
  {
    ...
    generos: ["deportes", "accion", "shounen", "psicologico", "drama", "escolar"], temporadas: 2, cover: "093.jpeg",
  ...
  {
    id: 94, titulo: "Jigokuraku", tipo: ["manga", "anime"],
    generos: ["accion", "aventura", "fantasia", "shounen", "historia", "sobrenatural"], temporadas: 2, cover: "094.jpeg",
  ...
  },
  {
    ...
    generos: ["accion", "isekai", "fantasia", "sobrenatural", "magia"], temporadas: 4, cover: "095.jpeg",
  ...
  },
  {
    ...
    generos: ["isekai", "fantasia", "accion", "drama", "aventura", "shounen"], temporadas: 3, cover: "096.jpeg",
  ...
  },
  {
    ...
    generos: ["accion", "historia", "militar", "seinen", "drama"], temporadas: 5, cover: "097.jpeg",
  ...
  },
  {
    ...
    generos: ["accion", "terror", "vampiros", "sobrenatural", "militar", "seinen"], temporadas: 1, cover: "098.jpeg",
  ...
  {
    id: 99, titulo: "Youjo Senki", tipo: ["manga", "anime"],
    generos: ["accion", "isekai", "militar", "magia", "fantasia"], temporadas: 2, cover: "099.jpeg",
  ...
  },
  {
    ...
    generos: ["accion", "historia", "aventura", "drama", "seinen"], temporadas: 2, cover: "100.jpeg",
